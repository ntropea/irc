...
void					Channel::erase(Client *client)
{
...
void					Channel::modErase(Client *client)
{
...
void					Channel::halfModErase(Client *client)
{
...
void					Channel::voiceErase(Client *client)
{
...
int						Channel::isMod(Client *client)
{
...
int						Channel::checkClient(Client *client)
{
...
int						Channel::bannedFind(std::string ban)
{
...
void					Channel::bannedInsert(std::string banName, std::string banNickMod, std::string banUserMod)
{
	Banned	inserted;
	struct timeval time; 
...
void					Channel::bannedErase(int pos)
{
